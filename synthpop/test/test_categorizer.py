...
def test_categorize(acs_data, pums_data):
    p_acs_cat = categorizer.categorize(
        acs_data,
        {
            ...
            ("race", "other"): "B02001_004E + B02001_006E + B02001_007E + B02001_008E",
    ...
    assert np.all(categorizer.sum_accross_category(p_acs_cat) < 2)
    ...
    pums_data, jd_persons = categorizer.joint_distribution(
        pums_data,
        categorizer.category_combinations(p_acs_cat.columns),
